...
varsGroup = c('ID_calle','NOM_CALLE','COD_NOMBRE',"hora_Subida","hora_Bajada",
              "timeVrec","BARRIO_baj","BARRIO_sub")
...
resPoint_filtro = resPoint %>% filter(BARRIO_sub == 'POCITOS')
rm(resPoint)
...
resPoint_filtro_agg = resPoint_filtro %>% 
...
save(resPoint_lf,file = 'Resultados/resPoint_lf.RData')
...
resPoint_lf_split = split(resPoint_lf,resPoint_lf$hora_Subida)
